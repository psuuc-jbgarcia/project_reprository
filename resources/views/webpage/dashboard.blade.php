 ...
 <!-- <link rel="stylesheet" href="{{ asset('css/style.css') }}"> -->
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="project-card" style="display: grid; grid-template-columns: repeat(3, minmax(280px, 1fr)); gap: 20px; padding: 20px; ">
    @foreach ($data as $project)
        <div style="background: #2d2d2d; border-radius: 10px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.15); overflow: hidden; transition: 0.3s; padding: 15px;">
            ...
            <div style="padding: 10px;">
                <h3 style="color: #f8f8f8; font-size: 18px; font-weight: bold; margin-top: 10px;">{{ $project->title }}</h3>
                <p style="color: #b0b0b0; font-size: 14px; margin-top: 5px;">{{ $project->description }}</p>
    ...
    style="background: #FFC107; color: #2d2d2d; border: none; padding: 6px 12px; border-radius: 5px; cursor: pointer; font-weight: bold;">
    ✏️ Edit
</button>

                        <a href="{{ route('delete',$project->id) }}" style="text-decoration: none;">
                        <button style="background: #E53935; color: white; border: none; padding: 6px 12px; border-radius: 5px; cursor: pointer; font-weight: bold;">
                            ❌ Delete
                        </button>
                        </a>
                    </div>
